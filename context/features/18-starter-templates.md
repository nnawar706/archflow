...
1. Create `components/starter-templates.ts`.
...
2. Create `components/starter-templates-modal.tsx`.

   The modal should:
   - open as a dialog (just like microsoft word template selection dialog panel)
